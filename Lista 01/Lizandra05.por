programa
{
	...
	funcao inicio()
	{
		...
		inteiro quantidadeSementes, quantidadeFeita, quantidadeNecessaria
		real ganho, preco
		...
		escreva("Quantas sementes são necessárias para fazer uma pulseira? ")
		leia(quantidadeNecessaria)
