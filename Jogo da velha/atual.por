programa
{
	...
	funcao logico jogar(caracter tipo)
	{
		...
		faca {
			...
			escreva("\nX=", (Tipos.inteiro_para_real(m.posicao_x()-39)/61), "; Y=", (Tipos.inteiro_para_real(m.posicao_y()-39)/61),
				   "\nX=", x, "; Y=", y)	
	...
	funcao desenhar(cadeia texto)
	{
		...
		para (inteiro i = 0; i < 3; i++)
		{
			para (inteiro j = 0; j < 3; j++)
			{
				...
				g.desenhar_texto(j*61+18+ajuste, i*61+14, Tipos.caracter_para_cadeia(posicoes[j][i]))
			}
		}
